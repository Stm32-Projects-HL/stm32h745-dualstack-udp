...
static VOID  _nx_driver_hardware_packet_received(VOID)
{
  //printf("_nx_driver_hardware_packet_received entered\r\n");  // debug
  ...
  {
	  //printf("NetX driver: got packet, length=%lu\r\n", (unsigned long)received_packet_ptr->nx_packet_length); // debug
...
void HAL_ETH_RxCpltCallback(ETH_HandleTypeDef *heth)
{
  ...
  /* Debug line */
  //printf("HAL_ETH_RxCpltCallback: RX interrupt\r\n");
